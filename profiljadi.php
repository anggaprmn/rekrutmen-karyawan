...
<head>
  ...
  <title>Science & Technology Company | Top Navigation</title>
                        ...
                        <?php
                          ...
                          <div class="card-body">
                            ...
                            <div class="form-group">
                              ...
                              <textarea class="form-control" name="txtalamat" placeholder="Masukkan Alamat (Jalan, nomor rumah, keterangan)"><?php echo $data_profil['alamat'] ?>, Ds. <?php echo $data_profil['desa'] ?>, Kec. <?php echo $data_profil['kecamatan'] ?>, <?php echo $data_profil['kabupaten'] ?>.</textarea>
                            </div>
                            <div class="row">
                              <div class="col-md-6">
                                <div class="form-group">
                                  <label for="exampleSelectBorder">Kelamin</label>
                                  <input type="text" name="txttanggal" class="form-control" id="exampleInputPassword1" value="<?php echo $data_profil['kelamin'] ?>">
                                </div>
                              </div>
                              <div class="col-md-6">
                                <div class="form-group">
                                  <label for="exampleSelectBorder">Agama</label>
                                  <input type="text" name="txttanggal" class="form-control" id="exampleInputPassword1" value="<?php echo $data_profil['agama'] ?>">
                                </div>
                              </div>
                            </div>
                            <div class="row">
                              <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  <input type="text" name="txttanggal" class="form-control" id="exampleInputPassword1" value="<?php echo $data_profil['status'] ?>">
                                </div>
                              </div>
                              <div class="col-md-6">
                                <div class="form-group">
                          ...
                          <div class="card-body">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                <div class="form-group">
                                  <label for="exampleInputPassword1">Nomor HP</label>
                                  <input type="number" class="form-control" name="txthp" id="exampleInputPassword1" placeholder="Masukkan Nomor HP">
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
